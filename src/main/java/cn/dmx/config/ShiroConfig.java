...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiorFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/statics/admin/images/**", "anon");
        filterChainDefinitionMap.put("/js/**", "anon");
        filterChainDefinitionMap.put("/templates/**", "anon");
        filterChainDefinitionMap.put("/admin/**", "anon");
        filterChainDefinitionMap.put("/layui/**", "anon");
        ...
        filterChainDefinitionMap.put("/toPath/login", "anon");
       ...
       filterChainDefinitionMap.put("/**", "authc");
        // 如果不设置默认会自动寻找Web工程根目录下的路径页面
        shiroFilterFactoryBean.setLoginUrl("/toPath/login");
        // 登录成功后要跳转的链接
